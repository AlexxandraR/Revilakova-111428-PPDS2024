...
Cieľom tohto zadania bolo implementovať riešenie problému hodujúcich
...
Vytvorila som si triedu **SimpleBarrier** reprezentujúcu jednoduchú bariéru. Medzi jej 
...
a nespraví signál s voliteľným parametrom určujúcim koľkokrát sa má metóda **signal**
...
že jedno vlákno (1) bude rýchlejšie, druhýkrát vojde do bariéry a obehne iné vlákno (2), 
...
bariéry. Pomocou semaforov v poli **in_semaphores** sa signalizuje prítomnosť vlákien v bariére od
listov ku koreňu. A naopak pomocou semaforov z poľa **out_semaphores** sa signalizuje 
otvorenie bariéry od koreňa ku listom. Teda, ak príde vlákno ku bariére, spraví **wait** na
semafory z **in_semaphores** na indexoch jeho potomkov. Ak obaja potomkovia spravili **signal** 
na svojich semaforoch, rodič môže spraviť **signal** na svojom semafore a následne **wait** na
svojom semafore z poľa **out_semaphores**. Takýmto spôsobom sa informácia o 
prítomnosti vlákien šíri od listov ku koreňu. Keď koreň dostane informáciu, že obaja 
jeho potomkovia sú pri bariére, znamená to, že všetky vlákna sú pri bariére, a tak môže vyslať
informáciu o otvorení bariéry, pomocou volania **signal**, na semafory svojich potomkov z poľa 
**out_semaphores**.
```
...
rýchlejšie a dostalo by sa do bariéry druhýkrát, zatiaľ čo iné vlákno (2) by z bariéry 
...
najprv všetci divosi prídu ku prvej bariére, následne sa bariéra otvorí. Prvý divoch vyjde
...
Savage 5 eats. The remaining portions: 8
Savage 3 eats. The remaining portions: 7
Savage 1 eats. The remaining portions: 6
Savage 0 eats. The remaining portions: 5
Savage 2 eats. The remaining portions: 4
Savage 4 eats. The remaining portions: 3
Savage 2 came to barrier 2. Total number at barrier 2: 1.
Savage 4 came to barrier 2. Total number at barrier 2: 2.
Savage 0 came to barrier 2. Total number at barrier 2: 3.
Savage 1 came to barrier 2. Total number at barrier 2: 4.
Savage 3 came to barrier 2. Total number at barrier 2: 5.
Savage 5 came to barrier 2. Total number at barrier 2: 6.
Savage 6 came to barrier 2. Total number at barrier 2: 7.
...
najprv všetci divosi prídu ku bariére, následne sa bariéra otvorí. Prvý divoch vyjde
a informuje kuchára o prázdnom hrnci. Zatiaľ čo kuchár varí jedlo aj zvyšní divosi 
opustia bariéru a čakajú kým si naberie prvý divoch. Potom si naberie druhý, tretí 
...
Savage 1 eats. The remaining portions: 8
Savage 3 eats. The remaining portions: 7
Savage 4 eats. The remaining portions: 6
Savage 2 eats. The remaining portions: 5
...
https://github.com/tj314/ppds-seminars/tree/ppds2024/seminar2